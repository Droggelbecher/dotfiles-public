...
if version >= 700
  hi Pmenu         guifg=#f0f0f0 guibg=#404040 gui=none
  hi PmenuSel      guifg=#ffffff guibg=#000000 gui=bold
  hi PmenuSbar                   guibg=#808080
  hi PmenuThumb    guifg=#a0c0b0
endif
...
hi FoldColumn guibg=#a0b0c0 guifg=#606060 gui=none
hi SignColumn guibg=#404040 guifg=#a0a0a0


hi TabLineFill guibg=#f0f0f0 guifg=#606060 gui=none
hi TabLine guibg=#d0d0d0 guifg=#606060 gui=none
hi TabLineSel guibg=#b0b0b0 guifg=#303030 gui=none

hi SpecialKey guibg=#f0f0f0 guifg=#a0a0a0 gui=none
...
hi Define guifg=#605080 guibg=#ece8f0 gui=none
hi Include guifg=#605080 guibg=#e0d8e0 gui=none
hi Structure guifg=#a09070 guibg=#f0e0c0 gui=none
...
hi treePart guifg=#808080 guibg=#f0f0f0 gui=none
hi treeOpenable guifg=#808080 guibg=#e0e0e0 gui=none
"hi Directory guibg=#f0f0f0 guifg=#4060a0 gui=none
hi Directory guifg=#406030 guibg=#d0e0d0 gui=none
hi treeDirSlash guibg=#f0f0f0 guifg=#404040 gui=none
