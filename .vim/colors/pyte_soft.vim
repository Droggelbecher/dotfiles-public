...
hi Normal    guifg=#506080   guibg=#f0f0f0
...
"hi String    guifg=#6090c0 
hi String    guifg=#c08070 
...
" HTML: arguments, C++: types
hi Type       guifg=#d8a06d gui=italic
...
" Cheetah: #-Symbol, function-names, Python: import etc..
hi PreProc    guifg=#3080c0 gui=NONE
...
hi Todo       guifg=#a07070 guibg=NONE gui=italic,bold,underline

" Python: %(...)s - constructs, encoding
hi Special    guifg=#e0a090 gui=italic

hi Operator   guifg=#408010

" color of <TAB>s etc...  
hi SpecialKey guifg=#000000 guibg=#f6f6f6 gui=italic  
