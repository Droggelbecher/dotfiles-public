...
if version >= 700
  ...
  exe 'hi Pmenu         guifg='.s:grey_blue     .' guibg='.s:darkest     .' gui=none'
  exe 'hi PmenuSel      guifg='.s:white     .' guibg='.s:dark_grey_blue   .' gui=none'
  exe 'hi PmenuSbar     guibg='.s:darkest
  exe 'hi PmenuThumb    guifg='.s:dark_grey_blue
endif
