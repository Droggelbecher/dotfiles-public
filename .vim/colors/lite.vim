...
hi LineNr    guifg=#444240 guibg=#a0b0c0 gui=NONE

hi Normal    guifg=#444240   guibg=#f0f0f0

hi StatusLine guifg=#000000 guibg=#8090a0 gui=italic
hi StatusLineNC guifg=#444240 guibg=#8090a0 gui=italic
hi VertSplit guifg=#8090a0 guibg=#8090a0 gui=NONE

" hi Folded    guifg=#708090 guibg=#c0d0e0
hi Folded    guifg=#808080 guibg=NONE gui=italic

hi NonText   guifg=#c0c0c0 guibg=#e0e0e0
" Kommentare
hi Comment   guifg=#848280

" Konstanten
hi Constant  guifg=#000000
hi String    guifg=#802000
hi Number    guifg=#20a010
hi Float     guifg=#609090
...
hi Statement   guifg=#607080 gui=bold
hi Operator  guifg=#802000 gui=bold
" HTML: arguments
"hi Type       guifg=#202020 gui=none
hi Type        guifg=#808080 gui=bold
" Python: Standard exceptions, True&False
hi Structure  guifg=#609090 gui=underline,bold
hi Function   guifg=#20a010 gui=bold
